...
plt.ylim(1,1000)
plt.yscale('log')
plt.suptitle('Normalized Pitch Angle Distribution at the Equator at L = 4.6 ', fontsize = 18, fontweight = 'bold')
...
plt.plot(data[0][0],data[1][2], 'r--', label = 'No Waves')
plt.plot(data[0][0],data[1][3], 'r:', label = 'No Waves')
...
plt.yscale('log')
plt.ylim(1,1000)
plt.suptitle('Normalized Pitch Angle Distribution at the Equator at L = 6.8 ', fontsize = 18, fontweight = 'bold')
...
plt.plot(data[0][0],data[7][2], 'r--', label = 'No Waves')
plt.plot(data[0][0],data[7][3], 'r:', label = 'No Waves')
plt.title('LBC', fontsize = 18, fontweight = 'bold')
plt.legend(loc='upper center', fontsize=12)
plt.xticks( fontsize = 14)
plt.yticks( fontsize = 14)
