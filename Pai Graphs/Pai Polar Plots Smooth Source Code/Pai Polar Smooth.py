...
for k in range(0,8):
    for i in range(0,8):
        data[k][0].append(180+180-data[0][0][7-i])
...
y = [0]*9
for i in range(0,9):
    y[i] = np.array(data[3][i])

y_smooth = [0]*9

for i in range(0,9): 
    y_smooth[i] = spline(x,y[i], x_smooth)
    
y2 = [0]*9
for i in range(0,9):
    y2[i] = np.array(data[6][i])

y2_smooth = [0]*9

for i in range(0,9): 
    y2_smooth[i] = spline(x,y2[i], x_smooth)
    
""" ECH 4.6 """
    
y3 = [0]*9
for i in range(0,9):
    y3[i] = np.array(data[0][i])

y3_smooth = [0]*9

for i in range(0,9): 
    y3_smooth[i] = spline(x,y3[i], x_smooth)
    
""" LBC 4.6 """

y4 = [0]*9
for i in range(0,9):
    y4[i] = np.array(data[1][i])

y4_smooth = [0]*9

for i in range(0,9): 
    y4_smooth[i] = spline(x,y4[i], x_smooth)
    
""" UBC 4.6 """

y5 = [0]*9
for i in range(0,9):
    y5[i] = np.array(data[2][i])

y5_smooth = [0]*9

for i in range(0,9): 
    y5_smooth[i] = spline(x,y5[i], x_smooth)
    
""" ECH 6.8 """

y6 = [0]*9
for i in range(0,9):
    y6[i] = np.array(data[4][i])

y6_smooth = [0]*9

for i in range(0,9): 
    y6_smooth[i] = spline(x,y6[i], x_smooth)
    
""" LBC 6.8 """

y7 = [0]*9
for i in range(0,9):
    y7[i] = np.array(data[5][i])

y7_smooth = [0]*9

for i in range(0,9): 
    y7_smooth[i] = spline(x,y7[i], x_smooth)
    
""" UBC 6.8 """

y8 = [0]*9
for i in range(0,9):
    y8[i] = np.array(data[7][i])

y8_smooth = [0]*9

for i in range(0,9): 
    y8_smooth[i] = spline(x,y8[i], x_smooth)
...
plt.plot(x_smooth, y_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y3_smooth[2], 'k', label = 'ECH')
...
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[3], 'r')
plt.plot(x_smooth, y3_smooth[3], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,3, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[4], 'r')
plt.plot(x_smooth, y3_smooth[4], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,4, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[6], 'r')
plt.plot(x_smooth, y3_smooth[6], 'k')
plt.ylim(0,3)


ax = plt.subplot(2,3,5, polar = True)
plt.plot(x_smooth, y_smooth[7], 'r')
plt.plot(x_smooth, y3_smooth[7], 'k')
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.ylim(0,3)
...
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y3_smooth[8], 'k', label = 'ECH')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y4_smooth[2], 'k', label = 'LBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.figtext(0.1,.78,'E = 2 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.1,.33,'E = 20 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.38,.78,'E = 5 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[3], 'r')
plt.plot(x_smooth, y4_smooth[3], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[4], 'r')
plt.plot(x_smooth, y4_smooth[4], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[6], 'r')
plt.plot(x_smooth, y4_smooth[6], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[7], 'r')
plt.plot(x_smooth, y4_smooth[7], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y4_smooth[8], 'k', label = 'LBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y5_smooth[2], 'k', label = 'UBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.figtext(0.1,.78,'E = 2 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.1,.33,'E = 20 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.38,.78,'E = 5 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[3], 'r')
plt.plot(x_smooth, y5_smooth[3], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[4], 'r')
plt.plot(x_smooth, y5_smooth[4], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[6], 'r')
plt.plot(x_smooth, y5_smooth[6], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[7], 'r')
plt.plot(x_smooth, y5_smooth[7], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y5_smooth[8], 'k', label = 'UBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y6_smooth[2], 'k', label = 'ECH')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.figtext(0.1,.78,'E = 2 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.1,.33,'E = 20 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.38,.78,'E = 5 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
...
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[3], 'r')
plt.plot(x_smooth, y6_smooth[3], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,3, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[4], 'r')
plt.plot(x_smooth, y6_smooth[4], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,4, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[6], 'r')
plt.plot(x_smooth, y6_smooth[6], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,5, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[7], 'r')
plt.plot(x_smooth, y6_smooth[7], 'k')
plt.ylim(0,3)

ax = plt.subplot(2,3,6, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y6_smooth[8], 'k', label = 'ECH')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y7_smooth[2], 'k', label = 'LBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.figtext(0.1,.78,'E = 2 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.1,.33,'E = 20 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.38,.78,'E = 5 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[3], 'r')
plt.plot(x_smooth, y7_smooth[3], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[4], 'r')
plt.plot(x_smooth, y7_smooth[4], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[6], 'r')
plt.plot(x_smooth, y7_smooth[6], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[7], 'r')
plt.plot(x_smooth, y7_smooth[7], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y7_smooth[8], 'k', label = 'LBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[2], 'r', label = 'No Waves')
plt.plot(x_smooth, y8_smooth[2], 'k', label = 'UBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.figtext(0.1,.78,'E = 2 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.1,.33,'E = 20 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
plt.figtext(0.38,.78,'E = 5 eV', fontsize = 18, fontweight = 'bold', rotation = 'vertical')
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[3], 'r')
plt.plot(x_smooth, y8_smooth[3], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[4], 'r')
plt.plot(x_smooth, y8_smooth[4], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[6], 'r')
plt.plot(x_smooth, y8_smooth[6], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[7], 'r')
plt.plot(x_smooth, y8_smooth[7], 'k')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y2_smooth[8], 'r', label = 'No Waves')
plt.plot(x_smooth, y8_smooth[8], 'k', label = 'UBC')
plt.legend(loc = 'lower center', fontsize = 'small')
plt.ylim(0,3)
...
plt.figtext(0.205,.03,'E = 20 eV', fontsize = 18, fontweight = 'bold')
plt.figtext(0.48,.03,'E = 30 eV', fontsize = 18, fontweight = 'bold')
plt.figtext(0.75,.03,'E = 50 eV', fontsize = 18, fontweight = 'bold')

ax = plt.subplot(2,3,1, polar = True)
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y3_smooth[6], 'k', label = 'ECH')
plt.plot(x_smooth, y4_smooth[6], 'b', label = 'LBC')
plt.plot(x_smooth, y5_smooth[6], 'g', label ='UBC')
plt.plot(x_smooth, y_smooth[6], 'r', label = 'No Waves')
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y3_smooth[7], 'k')
plt.plot(x_smooth, y4_smooth[7], 'b')
plt.plot(x_smooth, y5_smooth[7], 'g')
plt.plot(x_smooth, y_smooth[7], 'r')
plt.ylim(0,3)
...
ax.set_theta_zero_location("N")
ax.set_theta_direction(-1)
plt.plot(x_smooth, y3_smooth[8], 'k')
plt.plot(x_smooth, y4_smooth[8], 'b')
plt.plot(x_smooth, y5_smooth[8], 'g')
plt.plot(x_smooth, y_smooth[8], 'r')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y6_smooth[6], 'k')
plt.plot(x_smooth, y7_smooth[6], 'b')
plt.plot(x_smooth, y8_smooth[6], 'g')
plt.plot(x_smooth, y2_smooth[6], 'r')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y6_smooth[7], 'k')
plt.plot(x_smooth, y7_smooth[7], 'b')
plt.plot(x_smooth, y8_smooth[7], 'g')
plt.plot(x_smooth, y2_smooth[7], 'r')
plt.ylim(0,3)
...
ax.set_theta_direction(-1)
plt.plot(x_smooth, y6_smooth[8], 'k', label = 'ECH')
plt.plot(x_smooth, y7_smooth[8], 'b', label = 'LBC')
plt.plot(x_smooth, y8_smooth[8], 'g', label = 'UBC')
plt.plot(x_smooth, y2_smooth[8], 'r', label = 'No Waves')
plt.legend(loc= 'lower center', fontsize = 'small')
plt.ylim(0,3)
