...
for i in range(0,600):
    Eps4_6NoWaves[i] = 1-d2_10[i]/u2_10[i]
for i in range(0,600):
    Eps4_6ECH[i] = 1-d1_10[i]/u1_10[i]
for i in range(0,600):
    Eps4_6LBC[i] = 1-d3_10[i]/u3_10[i]
for i in range(0,600):
    Eps4_6UBC[i] = 1-d5_10[i]/u5_10[i]

for i in range(0,600):
    Eps6_8NoWaves[i] = 1-d8_10[i]/u8_10[i]
for i in range(0,600):
    Eps6_8ECH[i] = 1-d7_10[i]/u7_10[i]
for i in range(0,600):
    Eps6_8LBC[i] = 1-d9_10[i]/u9_10[i]
for i in range(0,600):
    Eps6_8UBC[i] = 1-d11_10[i]/u11_10[i]
    
plt.subplot(1,2,1)
plt.plot(u1_2[0:600],Eps4_6NoWaves, 'k', label='Epsilon No Waves')
plt.plot(u1_2[0:600],Eps4_6ECH, 'r', label='Epsilon ECH')
plt.plot(u1_2[0:600],Eps4_6LBC, 'b', label='Epsilon LBC')
plt.plot(u1_2[0:600],Eps4_6UBC, 'g', label='Epsilon UBC')
...
plt.subplot(1,2,2)
plt.plot(u1_2[0:600],Eps6_8NoWaves, 'k', label='Epsilon No Waves')
plt.plot(u1_2[0:600],Eps6_8ECH, 'r', label='Epsilon ECH')
plt.plot(u1_2[0:600],Eps6_8LBC, 'b', label='Epsilon LBC')
plt.plot(u1_2[0:600],Eps6_8UBC, 'g', label='Epsilon UBC')
plt.title('L = 6.8')
plt.ylabel('Epsilon')
plt.xlabel('Energy (eV)')
plt.xscale('log')
